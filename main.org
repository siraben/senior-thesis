...
#+BEGIN_abstract
In this work, we focus on Wigderson's graph coloring algorithm and its
formal correctness, while also exploring the broader context of graph
theory formalization in computer science and mathematics. Although
graph theory boasts a rich history and extensive applications, its
formal developments have often been limited to specific use-cases or
graph definitions. We provide a comprehensive review of various
...
** Writing Proofs in Coq: Tactics and Proof Terms
...
** Phase II Lemmas
In phase 2, we color a graph with maximum degree $d$ with $d+1$
...
* Implementing Wigderson's Algorithm in Coq
We have described the phases of the algorithm is pseudocode, but we now must translate this into Coq. We will do this in a manner corresponding to our lemmas. We will apply these lemmas to our functions and prove correctness and robustness.
